...
$string['programmingexplain'] = 'This is the configuration for the Source-code Plagiarism Detection plugin';
...
$string['account_instruction'] = 'The plugin uses MOSS engine in the background. An account is required to use the MOSS engine.';
