...
M.plagiarism_programming.assignment_setting = {
    ...
    init : function(Y, moss_support) {
        this.Y = Y;
        this.init_mandatory_field();
        this.init_disable_unsupported_tool(Y, moss_support);
        this.enable_disable_elements(Y, moss_support);
    },
    ...
    init_disable_unsupported_tool: function(Y, moss_lang) {
        Y.all('input[name=programmingYN]').on('click', function() {
            this.enable_disable_elements(Y, moss_lang);
        }, this);
    ...
    enable_disable_elements: function(Y, moss_lang) {
